...
const DefaultData: IMixedChartConfig = {
    ...
    const actions = [
      {
        ...
        command: (builder: any, userInputData: any) => {
          let oldData: IMixedChartConfig = DefaultData;
          let oldTag = {};
          return {
            execute: async () => {
              ...
              if (advancedSchema) {
                ...
                this._data = { ...generalSettings as IMixedChartConfig, options };
              }
      ...
      },
      {
        ...
        icon: 'database',
        command: (builder: any, userInputData: any) => {
          let _oldData: IMixedChartConfig = DefaultData;
          return {
            execute: async () => {
              _oldData = { ...this._data };
        ...
        customUI: {
          render: (data?: any, onConfirm?: (result: boolean, data: any) => void, onChange?: (result: boolean, data: any) => void) => {
            ...
            const dataOptionsForm = new ScomMixedChartDataOptionsForm(null, {
