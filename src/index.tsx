...
import { PageBlock, IMixedChartConfig, callAPI, formatNumber, groupByCategory, extractUniqueTimes, concatUnique, groupArrayByKey, formatNumberByFormat, getChartType } from './global/index';
...
export default class ScomMixedChart extends Module implements PageBlock {
  ...
  private _oldData: IMixedChartConfig = { apiEndpoint: '', options: undefined };
  ...
  async setData(data: IMixedChartConfig) {
